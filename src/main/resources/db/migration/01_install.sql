...
create table topics (topic_id integer not null, inserted_date timestamp, updated_date timestamp, version integer, question varchar(255) not null, score varchar(255) not null, topic varchar(255) not null, primary key (topic_id));
